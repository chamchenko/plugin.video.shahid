...
QUALITY         = REAL_SETTINGS.getSetting('Quality')
QUALITIES       = ['1080','720','576','468','360','252','144']
...
PLAYOUT_URL     = API_Base + 'playout/url/%s'
PLAYOUT_URL2    = API_Base + 'playout/new/url/%s'
